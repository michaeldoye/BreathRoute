...
# Cloud Scheduler only supports specific regions
# europe-west1 is the closest supported region to europe-west4
locals {
  scheduler_region = var.region == "europe-west4" ? "europe-west1" : var.region
}
